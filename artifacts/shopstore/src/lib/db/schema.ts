...
export const orders = pgTable("orders", {
  ...
  status: text("status", { enum: ['pending', 'paid', 'failed', 'review', 'waiting', 'confirming', 'sending', 'partially_paid', 'refunded', 'expired'] }).notNull().default("pending"),
...
export const siteSettings = pgTable("site_settings", {
  ...
  announcementText: text("announcement_text").default("Pay with crypto via NOWPayments, or message us on WhatsApp for alternate payment options."),
  ...
  nowPaymentsUrl: text("now_payments_url").default("https://nowpayments.io/payment/?iid=replace-with-your-invoice"),
